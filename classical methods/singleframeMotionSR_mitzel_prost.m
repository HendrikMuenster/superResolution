function [imgSR,timings] = singleframeMotionSR_mitzel_prost(imageSequenceSmall,factor,alpha,beta,comp_mode)
...
% with the following adaption: 
% Optical flows are not estimated from linearly many as suggested in the paper, but computed directly for all couplings
% to evaluate the performance in comparison to Unger et al.
%% 1) Init
timings = zeros(2,1);
